...
public class WildfireFireballEntity extends AbstractFireballEntity {
    public double explosionPower = Outvoted.config.get().entities.wildfire.attacking.fireballexplosionpower;
    public boolean doExplode = Outvoted.config.get().entities.wildfire.attacking.dofireballexplosion;
