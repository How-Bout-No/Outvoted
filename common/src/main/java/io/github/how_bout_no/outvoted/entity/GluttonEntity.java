...
public class GluttonEntity extends PathAwareEntity implements IAnimatable {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(3, new ActiveTargetGoal<>(this, LivingEntity.class, 10, true, false, (entity) -> {
            return this.squaredDistanceTo(entity) < 2 && !(entity instanceof CreeperEntity);
        }));
    }
