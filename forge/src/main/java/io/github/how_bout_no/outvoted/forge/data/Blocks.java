...
public class Blocks extends BlockModelProvider {
    ...
    protected void registerModels() {
        buttonModel("copper_button", new Identifier("block/copper_block"));
        buttonModel("exposed_copper_button", new Identifier("block/exposed_copper"));
        buttonModel("weathered_copper_button", new Identifier("block/weathered_copper"));
        buttonModel("oxidized_copper_button", new Identifier("block/oxidized_copper"));
        buttonModel("waxed_copper_button", new Identifier("block/copper_block"));
        buttonModel("waxed_exposed_copper_button", new Identifier("block/exposed_copper"));
        buttonModel("waxed_weathered_copper_button", new Identifier("block/weathered_copper"));
        buttonModel("waxed_oxidized_copper_button", new Identifier("block/oxidized_copper"));
    }
...
//        singleTexture(type + "_sign", new ResourceLocation(Outvoted.MOD_ID, textureBase + "_planks"));
    ...
    private void buttonModel() {
        buttonModel(type + "_button", new Identifier(Outvoted.MOD_ID, textureBase + "_planks"));
    }

    private void buttonModel(String path, Identifier texture) {
