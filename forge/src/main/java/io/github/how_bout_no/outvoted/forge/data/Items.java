...
//        withExistingParent("burrow", new Identifier(Outvoted.MOD_ID, "block/burrow"));
        withExistingParent("copper_button", new Identifier(Outvoted.MOD_ID, "block/copper_button_inventory"));
        withExistingParent("exposed_copper_button", new Identifier(Outvoted.MOD_ID, "block/exposed_copper_button_inventory"));
        withExistingParent("weathered_copper_button", new Identifier(Outvoted.MOD_ID, "block/weathered_copper_button_inventory"));
        withExistingParent("oxidized_copper_button", new Identifier(Outvoted.MOD_ID, "block/oxidized_copper_button_inventory"));
        withExistingParent("waxed_copper_button", new Identifier(Outvoted.MOD_ID, "block/waxed_copper_button_inventory"));
        withExistingParent("waxed_exposed_copper_button", new Identifier(Outvoted.MOD_ID, "block/waxed_exposed_copper_button_inventory"));
        withExistingParent("waxed_weathered_copper_button", new Identifier(Outvoted.MOD_ID, "block/waxed_weathered_copper_button_inventory"));
        withExistingParent("waxed_oxidized_copper_button", new Identifier(Outvoted.MOD_ID, "block/waxed_oxidized_copper_button_inventory"));
