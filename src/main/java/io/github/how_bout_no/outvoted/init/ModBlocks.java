...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PALM_DOOR = BLOCKS.register("palm_door", () -> new FenceGateBlock(Block.Properties.from(Blocks.JUNGLE_DOOR)));
    ...
    public static final RegistryObject<Block> PALM_WALL_SIGN = BLOCKS.register("palm_wall_sign", () -> new WallSignBlock(AbstractBlock.Properties.from(Blocks.JUNGLE_WALL_SIGN), WoodType.JUNGLE));
    ...
    public static final RegistryObject<Item> PALM_DOOR_ITEM = BLOCK_ITEMS.register("palm_door", () -> new ModBlockItem(PALM_DOOR.get(), new Item.Properties()));
