...
public class ModItems {
    ...
    public static final RegistryObject<Item> WILDFIRE_SPAWN_EGG = ITEMS.register("wildfire_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.WILDFIRE, 0xF6B201, 0x000000, ITEM_PROPERTIES));
    public static final RegistryObject<Item> GLUTTON_SPAWN_EGG = ITEMS.register("glutton_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.GLUTTON, 0xF0D786, 0x000000, ITEM_PROPERTIES));
    public static final RegistryObject<Item> BARNACLE_SPAWN_EGG = ITEMS.register("barnacle_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.BARNACLE, 0x5B872E, 0x000000, ITEM_PROPERTIES));
    public static final RegistryObject<Item> GLARE_SPAWN_EGG = ITEMS.register("glare_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.GLARE, 0x325F03, 0x97D756, ITEM_PROPERTIES));
