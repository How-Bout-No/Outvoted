...
public class ModItems {
    ...
    // Spawn Eggs
    public static final RegistryObject<ModdedSpawnEggItem> WILDFIRE_SPAWN_EGG = ITEMS.register("inferno_spawn_egg",
    ...
    // Items
    public static final RegistryObject<Item> WILDFIRE_HELMET = ITEMS.register("inferno_helmet", WildfireHelmetItem::new);
    public static final RegistryObject<Item> WILDFIRE_SHIELD = ITEMS.register("inferno_shield", WildfireShieldItem::new);
    public static final RegistryObject<Item> WILDFIRE_SHIELD_PART = ITEMS.register("inferno_shield_part", () -> new ModItem(new Item.Properties().isImmuneToFire()));
    public static final RegistryObject<Item> WILDFIRE_PIECE = ITEMS.register("inferno_piece", () -> new ModItem(new Item.Properties()));
