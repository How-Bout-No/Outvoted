...
public class GluttonRenderer extends GeoMobRenderer<GluttonEntity> {
    ...
    @Override
    public RenderType getRenderType(GluttonEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
