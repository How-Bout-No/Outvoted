...
public class WildfireEntity extends Monster implements IAnimatable {
    ...
    static {
        SHIELDING = SynchedEntityData.defineId(WildfireEntity.class, EntityDataSerializers.BOOLEAN);
        ON_FIRE = SynchedEntityData.defineId(WildfireEntity.class, EntityDataSerializers.BYTE);
        ATTACKING = SynchedEntityData.defineId(WildfireEntity.class, EntityDataSerializers.BOOLEAN);
        VARIANT = SynchedEntityData.defineId(WildfireEntity.class, EntityDataSerializers.INT);
    }
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            for (int i = 0; i <= (fireballcount - 1); ++i) {
                                ...
                                wildfirefireballentity = new WildfireFireballEntity(this.mob.level, this.mob, x, y, z);
