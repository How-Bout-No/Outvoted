...
public class Barnacle extends Monster implements IAnimatable {
    ...
    static class ChaseGoal extends MoveTowardsTargetGoal {
        ...
        public ChaseGoal(Barnacle barnacle, double speedIn, float maxDistanceIn) {
    ...
    static class AttackGoal extends Goal {
        ...
        public AttackGoal(Barnacle entity) {
            this.mob = entity;
    ...
    static class MoveHelperController extends MoveControl {
        ...
        public MoveHelperController(Barnacle entity) {
            super(entity);
            this.mob = entity;
        }
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<Barnacle> controller = new AnimationController<>(this, "controller", 3, this::predicate);
