...
public class InfernoEntity extends MonsterEntity implements IAnimatedEntity {
    ...
    private static final DataParameter<Boolean> MELEEING = EntityDataManager.createKey(InfernoEntity.class, DataSerializers.BOOLEAN);
    ...
    public <E extends Entity> boolean animationPredicate(AnimationTestEvent<E> event) {
        if (this.shielding()) {
            ...
            controller.setAnimation(new AnimationBuilder().addAnimation("animation.inferno.melee"));
        }
        else {
    ...
    protected void registerData() {
        ...
        this.dataManager.register(MELEEING, Boolean.FALSE);
    }
    ...
    public void meleeing(boolean meleeing) { this.dataManager.set(MELEEING, meleeing);}

    public boolean meleeing(){return this.dataManager.get(MELEEING);}
