...
public class RepairCostRecipe extends SpecialRecipe {
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                if (list.size() > 1) {
                    ...
                    if ((!(itemstack.getItem() == ModItems.HUNGER_TOOTH.get()) && !(itemstack1.getItem() == ModItems.HUNGER_TOOTH.get())) || ((!(itemstack.getItem() instanceof TieredItem) && !(itemstack.getItem() instanceof ArmorItem)) && (!(itemstack1.getItem() instanceof TieredItem) && !(itemstack1.getItem() instanceof ArmorItem)))) {
                        return false;
                    }
                }
            }
    ...
    public ItemStack getCraftingResult(CraftingInventory inv) {
        ...
        if (list.size() == 2) {
            ...
            System.out.println(itemstack4.getItem());
            if ((itemstack3.getItem() == ModItems.HUNGER_TOOTH.get() || itemstack4.getItem() == ModItems.HUNGER_TOOTH.get()) && ((itemstack3.getItem() instanceof TieredItem || itemstack3.getItem() instanceof ArmorItem) || (itemstack4.getItem() instanceof TieredItem || itemstack4.getItem() instanceof ArmorItem))) {
                Item item;
