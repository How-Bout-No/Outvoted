...
import com.hbn.outvoted.entities.oceanmonster.OceanRenderer;
...
public class ClientEventBusSubscriber {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.OCEANMONSTER.get(), OceanRenderer::new);
    }
