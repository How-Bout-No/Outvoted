...
public class InfernoModel<T extends InfernoEntity & IAnimatedEntity> extends AnimatedEntityModel<T> {
    ...
    public InfernoModel()
    {
        ...
        helmet.setTextureOffset(33, 14).addBox(-2.5F, -8.5F, 1.5F, 1.0F, 9.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 17).addBox(-2.5F, -7.5F, 2.5F, 1.0F, 4.0F, 7.0F, 0.0F, false);
        helmet.setTextureOffset(24, 17).addBox(-10.5F, -7.5F, 2.5F, 1.0F, 4.0F, 7.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-2.5F, -8.5F, 3.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-2.5F, -8.5F, 5.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-2.5F, -8.5F, 7.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(33, 14).addBox(-2.5F, -8.5F, 9.5F, 1.0F, 9.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(33, 14).addBox(-10.5F, -8.5F, 1.5F, 1.0F, 9.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-10.5F, -8.5F, 3.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-10.5F, -8.5F, 5.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-10.5F, -8.5F, 7.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(33, 14).addBox(-10.5F, -8.5F, 9.5F, 1.0F, 9.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-8.5F, -8.5F, 9.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-6.5F, -8.5F, 9.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 0).addBox(-4.5F, -8.5F, 9.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(4, 2).addBox(-9.5F, -3.5F, 1.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(0, 2).addBox(-3.5F, -3.5F, 1.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 2).addBox(-9.5F, -7.5F, 1.5F, 7.0F, 2.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(32, 8).addBox(-7.0F, -8.0F, 1.25F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 28).addBox(-9.5F, -7.5F, 9.5F, 7.0F, 7.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(24, 6).addBox(-8.5F, -8.5F, 1.5F, 5.0F, 1.0F, 1.0F, 0.0F, false);
        helmet.setTextureOffset(0, 0).addBox(-7.5F, -9.5F, 1.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);
